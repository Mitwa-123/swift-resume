...
export default function PaymentDialog({ onNext, isDesktop }) {
	...
	const Content = (
		<div className="w-full lg:w-204.5 mx-auto">
			<div className=" grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<div className="flex flex-col gap-6">
								...
								{plans.map((plan) => {
									...
									return (
										...
										>
											<div
												className={cn(
													"flex h-5.5 w-5.5 items-center justify-center rounded-full border",
													isSelected
							...
							{isDesktop && (
								<p className="text-center text-xs leading-4 font-regular text-slate-400">
									...
									renews at the same rate. The 7-day plan renews at
				...
				<div className="rounded-[14px] bg-none sm:bg-slate-100 border-none sm:border px-0 sm:px-8 py-0 sm:py-10 w-full">
					<div className="grid grid-cols-2 gap-4">
						<Button className="h-12.5 border-none ring-0 shadow-none focus-visible:ring-0 focus-visible:outline-none bg-black w-full">
					...
					<form onSubmit={form.handleSubmit(onSubmit)}>
						...
						<div className="flex items-center justify-between mt-6 lg:hidden w-full">
							<div className="flex items-center gap-2">
								<ShieldCheck className="h-6 w-6 text-green-600" />
								<div className="flex flex-col">
									<Text variant="h4" weight="medium" className="text-slate-800">
										Secure
									</Text>
									<Text variant="h4" className="text-slate-500">
										Pay via Stripe
									</Text>
								</div>
							</div>
							...
							<div className="flex items-center gap-2">
								<div className="flex items-center justify-center h-6 w-6 bg-light-purple rounded-lg">
									<span className="text-lg font-bold text-base-white">S</span>
								</div>
								<div className="flex flex-col">
									<Text variant="h4" weight="medium" className="text-slate-800">
										Trusted
						...
						{!isDesktop && (
							<p className="text-center text-xs leading-4 font-regular text-slate-400 mt-6">
								Cancel anytime. Refundable for 7 days after the first payment.
								The yearly plan renews at the same rate. The 7-day plan renews
								at $19.95/month.
							</p>
						)}
					</form>
