...
export default function TemplateCard({ image, title, tags }) {
  ...
  return (
    <div className="flex flex-col group cursor-pointer">
      <div className="overflow-hidden rounded-lg border border-border  relative w-74.5 h-105.5 transition-all duration-700 hover:ring-2 hover:ring-base-primary hover:ring-offset-2 delay-500">
