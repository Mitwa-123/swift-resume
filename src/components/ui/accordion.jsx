...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      <div
        className={cn(
          "h-(--accordion-panel-height) pt-0 p-2.5 sm:p-6 data-ending-style:h-0 data-starting-style:h-0 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground [&_p:not(:last-child)]:mb-4",
          className
        )}>
        {children}
      </div>
